...
class FrontendChessboardBuilderTest {
    ...
    void testCreateButtons() {
        ...
        when(this.frontendChessboard.getGame()).thenReturn(game);
        when(this.frontendChessboard.getFrontendFields()).thenReturn(new ArrayList<>());
        when(game.getChessboard()).thenReturn(chessboard);

        FrontendChessboard result = frontendChessboardBuilder.setBoard(this.frontendChessboard).createButtons().build();
    ...
    void testUpdateButtons() {
        ...
        when(this.frontendChessboard.getGame()).thenReturn(game);
        when(game.getChessboard()).thenReturn(chessboard);
        when(this.frontendChessboard.getFrontendFields()).thenReturn(frontendFields);
        ...
        FrontendChessboard result = frontendChessboardBuilder.setBoard(this.frontendChessboard).updateButtons().build();
